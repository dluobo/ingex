/*
 * $Id: RouterConfig.h,v 1.1 2007/01/30 12:46:20 john_f Exp $
 *
...
public:
    ...
    bool getSourcePackage(uint32_t index, SourceSession* session, SourcePackage** package, uint32_t* sourceTrackID);
