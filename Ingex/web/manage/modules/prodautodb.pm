...
sub save_source_config
{
    ...
    eval
    {
        ...
        foreach my $track (@{ $scf->{"tracks"} })
        {
            ...
            $sth->bind_param(2, $track->{"TRACK_ID"}, SQL_VARCHAR);
        ...
        foreach my $track (@{ $scf->{"tracks"} })
        {
            ...
            my $sth = $dbh->prepare("
                ...
                WHERE
                    sct_identifier = ?
                ");
            $sth->bind_param(1, $track->{"TRACK_ID"}, SQL_VARCHAR);
...
sub save_multicam_config
{
    ...
    eval
    {
        ...
        foreach my $track (@{ $mccf->{"tracks"} })
        {
            ...
            $sth->bind_param(3, $track->{'config'}->{"TRACK_NUMBER"}, SQL_VARCHAR);
...
sub update_multicam_config
{
    ...
    eval
    {
        ...
        foreach my $track (@{ $mccf->{"tracks"} })
        {
            ...
            $sth->bind_param(2, $track->{'config'}->{"TRACK_NUMBER"}, SQL_VARCHAR);
