/***************************************************************************
 *   $Id: help.cpp,v 1.22 2010/10/05 10:49:02 john_f Exp $                *
 *                                                                         *
...
: wxDialog(parent, wxID_ANY, (const wxString &) wxT("Ingex Control Help"), wxDefaultPosition, wxSize(600, 400), wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER) //cygwin needs the cast
{
    ...
    wxTextCtrl * qs = new wxTextCtrl(notebook, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
    ...
    wxTextCtrl * project = new wxTextCtrl(notebook, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
    ...
    wxTextCtrl * cuePoints = new wxTextCtrl(notebook, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
    ...
    wxTextCtrl * roll = new wxTextCtrl(notebook, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
    ...
    wxTextCtrl * tapeIds = new wxTextCtrl(notebook, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
    ...
    wxTextCtrl * indicators = new wxTextCtrl(notebook, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
    ...
    wxTextCtrl * transport = new wxTextCtrl(notebook, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
    ...
    wxTextCtrl * recordTab = new wxTextCtrl(notebook, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
    ...
    wxTextCtrl * player = new wxTextCtrl(notebook, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
    ...
    wxTextCtrl * jogshuttle = new wxTextCtrl(notebook, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
    ...
    wxTextCtrl * test = new wxTextCtrl(notebook, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_MULTILINE);
