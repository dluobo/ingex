...
window.injax = new Object({
	...
	insole : {
		...
		outputDiv : 'consoleOutput', // should be a block level element
	...
	// ===== DOM ELEMENTS AND STYLES TO USE =====
