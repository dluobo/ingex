...
#$PRERUN /usr/local/bin/player --disable-shuttle --show-tc LTC.0 --audio-lineup -18 --audio-mon 2 --source-aspect 16:9 --quad-split --hide-progress-bar --shm-in 0s --shm-in 1s --shm-in 2s --shm-in 3s
