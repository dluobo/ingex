...
# normal quad view
#/usr/local/bin/player --show-tc LTC.0 --audio-lineup -18 --audio-mon 4 --source-aspect 16:9 --quad-split --hide-progress-bar --shm-in 0p --shm-in 1p --shm-in 2p --shm-in 3p
