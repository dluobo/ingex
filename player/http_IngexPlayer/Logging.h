...
#ifndef __INGEX_LOGGING_H__
#define __INGEX_LOGGING_H__
...
// eg. INGEX_LOGTHROW(("Something failed with error %d", 1));
#define INGEX_LOGTHROW(params) \
    Logging::error params; \
    Logging::errorMore(false, ", near %s:%d\n", __FILE__, __LINE__); \
    throw IngexException params;

// eg. INGEX_LOG(warning, ("Something might be wrong here %d", 1));
#define INGEX_LOG(type, params) \
    Logging::type params; \
