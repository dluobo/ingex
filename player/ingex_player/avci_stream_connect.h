...
#ifndef __AVCI_STREAM_CONNECT_H__
#define __AVCI_STREAM_CONNECT_H__
...
/* connector that decodes AVC-Intra only */
...
/* use AVC-Intra decoders as a static and reusable resource */
