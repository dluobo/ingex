    ...
    for (i = 0; i < numTracks; i++)
    {
        ...
        if (track->isVideo)
        {
            ...
            if (mxf_equals_ul(&track->essenceContainerLabel, &MXF_EC_L(SD_Unc_625_50i_422_135_FrameWrapped)) ||
                ...
                mxf_equals_ul(&track->essenceContainerLabel, &MXF_EC_L(HD_Unc_720_25p_422_FrameWrapped)) ||
                     ...
                     mxf_equals_ul(&track->essenceContainerLabel, &MXF_EC_L(DVBased_100_720_60_P_FrameWrapped)))
            {
                ...
                mxf_equals_ul(&track->essenceContainerLabel, &MXF_EC_L(DNxHD1080p120ClipWrapped)) ||
                mxf_equals_ul(&track->essenceContainerLabel, &MXF_EC_L(DNxHD1080p185ClipWrapped)) ||
