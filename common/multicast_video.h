...
typedef struct {
	...
	uint8_t		signal_ok;
	char		source_name[80];		// size 80 includes terminating NUL
} IngexNetworkHeader;

#define PACKET_SIZE 1475
...
extern int send_audio_video(int fd, int width, int height, const uint8_t *video, const uint8_t *audio, int frame_number, int vitc, int ltc);
