...
{
    send_replay_command("step?forward=true&unit=FRAME_PLAY_UNIT");
}

function step_backwards()
{
    send_replay_command("step?forward=false&unit=FRAME_PLAY_UNIT");
}
...
function next_vtr_error_level()
{
    send_replay_command("next-vtr-error-level");
}

function next_show_marks()
{
    send_replay_command("next-show-marks");
}
...
function update_vtr_error_level_state(level)
{
    var nextVTRErrorLevelButtonE = document.getElementById("next-vtr-error-level");
    if (nextVTRErrorLevelButtonE == null)
    {
        return;
    }
    ...
    {
        case 0:
            if (nextVTRErrorLevelButtonE.src != "images/vtr_error_hide_symbol.png")
            {
                nextVTRErrorLevelButtonE.src = "images/vtr_error_hide_symbol.png";
            }
            break;
        case 1:
            if (nextVTRErrorLevelButtonE.src != "images/vtr_error_l1_symbol.png")
            {
                nextVTRErrorLevelButtonE.src = "images/vtr_error_l1_symbol.png";
            }
            break;
        case 2:
            if (nextVTRErrorLevelButtonE.src != "images/vtr_error_l2_symbol.png")
            {
                nextVTRErrorLevelButtonE.src = "images/vtr_error_l2_symbol.png";
            }
            break;
        case 3:
            if (nextVTRErrorLevelButtonE.src != "images/vtr_error_l3_symbol.png")
            {
                nextVTRErrorLevelButtonE.src = "images/vtr_error_l3_symbol.png";
            }
            break;
        case 4:
            if (nextVTRErrorLevelButtonE.src != "images/vtr_error_l4_symbol.png")
            {
                nextVTRErrorLevelButtonE.src = "images/vtr_error_l4_symbol.png";
            }
            break;
        default:
            if (nextVTRErrorLevelButtonE.src != "images/vtr_error_l1_symbol.png")
...
function update_mark_filter_state(typeMask)
{
    var showMarksButtonE = document.getElementById("show-marks-cmd");
    if (showMarksButtonE == null)
    {
        return;
    }
    ...
    switch (typeMask)
    {
        case 0x00000000: // no marks
            if (showMarksButtonE.src != "images/show_no_marks.png")
            {
                showMarksButtonE.src = "images/show_no_marks.png";
            }
            break;
        case 0x00010000: // VTR error
            if (showMarksButtonE.src != "images/show_vtr_marks.png")
            {
                showMarksButtonE.src = "images/show_vtr_marks.png";
            }
            break;
        case 0x00040000: // DigiBeta dropout error
            if (showMarksButtonE.src != "images/show_digibeta_dropout_marks.png")
            {
                showMarksButtonE.src = "images/show_digibeta_dropout_marks.png";
            }
            break;
        case 0x00080000: // Timecode break
            if (showMarksButtonE.src != "images/show_tc_break_marks.png")
            {
                showMarksButtonE.src = "images/show_tc_break_marks.png";
            }
            break;
        default:
            if (showMarksButtonE.src != "images/show_all_marks.png")
            {
                showMarksButtonE.src = "images/show_all_marks.png";
            }
            break;
    }
}
