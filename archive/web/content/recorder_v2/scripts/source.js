    ...
    if (result != null && result.error)
    {
        ...
        switch (result.errorCode)
        {
            ...
            case 4: // SOURCE_VTR_CONNECT_FAILURE:
                message += "no VTR connection";
                break;
            case 5: // SOURCE_VTR_REMOTE_LOCKOUT_FAILURE:
                message += "VTR remote lockout";
                break;
            case 6: // NO_SOURCE_TAPE:
                message += "no tape";
                break;
            // 7, 8, and 9 are ignored because they are related to the 
            // digibeta backup
...
function set_source_info(sourceInfo)
{
    ...
    if (sourceInfo.warningCode != null)
    {
        ...
        {
            case 0:
                message += "Source has been ingested before";
                break;
            default:
                // unknown code - use the supplied message
...
function autocorrect_barcode(inputField)
{
    // make uppercase
...
function select_source(inputField)
{
    autocorrect_barcode(inputField);
