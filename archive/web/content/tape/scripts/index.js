...
function set_system_status(status)
{
    if (status == null)
    {
        ...
        update_tag_value("tape-export-version", "", "");
    ...
    else
    {
        ...
        update_tag_value("tape-export-version", versionString, versionString);
...
function request_status()
{
    ...
    statusRequest.open("GET", "/tape/status.json?system=true", true);
