/*
 * $Id: AudioMixer.cpp,v 1.1 2006/04/30 08:38:05 stuart_hc Exp $
 *
...
/**
Constructor - specify the type of mix matrix you want.
*/
AudioMixer::AudioMixer(EnumeratedMatrix matrix)
{
